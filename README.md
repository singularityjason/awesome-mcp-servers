...
- 🧠 [omega-memory](https://github.com/omega-memory/omega-memory) - Persistent memory for AI coding agents with semantic search, auto-capture, and cross-session learning. #1 on LongMemEval benchmark (95.4%). Local-first with zero cloud dependency.
